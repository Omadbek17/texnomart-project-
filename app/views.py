...
from app.models import Category,Product,Comment,Attribute,AttributeValue,ProductAttribute
from app.serializers import ProductModelSerializer,CategoryModelSerializer,CategoryDetailModelSerializer,AttributeKeySerializer,AttributeValueSerializer,ProductAttributesSerializer
